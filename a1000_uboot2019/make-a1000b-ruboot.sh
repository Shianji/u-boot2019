...
BINOUT=bin_a1000b_ru
BUILDOUT=build_a1000b_ru
...
make O=${BUILDOUT} CROSS_COMPILE=${CROSS_COMPILETOOL} bsta1000b_ruboot_defconfig
...
mv ATF-u-boot.bin RUBOOT-A1000B-512K.bin
cd -
