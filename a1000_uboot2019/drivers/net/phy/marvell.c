...
#define MIIM_88E151x_MODE_MASK		7
#define MIIM_88E151x_MODE_RGMII_TO_SGMII	4
...
static int m88e1011s_startup(struct phy_device *phydev)
{
	...
	/*Switch to Fipper page*/
	if (phydev->flags & PHY_FIBER_MODE)
...
static int m88e1518_config(struct phy_device *phydev)
{
	...
	if (phydev->flags & PHY_FIBER_MODE) {
		/*FADA & FADB ETH0 phy 88e1512 working in RGMII to SGMII mode*/
		phy_write(phydev, MDIO_DEVAD_NONE, MII_MARVELL_PHY_PAGE, 18);
		reg = MIIM_88E151x_GENERAL_CTRL;
		val = phy_read(phydev, MDIO_DEVAD_NONE, reg);
		val &=  ~MIIM_88E151x_MODE_MASK;
		val |=  MIIM_88E151x_MODE_RGMII_TO_SGMII;
		reg = MIIM_88E151x_GENERAL_CTRL;
