...
static char g_dnl_manufacturer[MAX_STRING_MANUFACT];
...
void g_dnl_set_manufacturer(char *s)
{
	memset(g_dnl_manufacturer, 0, MAX_STRING_MANUFACT);
	strncpy(g_dnl_manufacturer, s, MAX_STRING_MANUFACT - 1);
}
